...
def main():
	import argparse
	oParser = argparse.ArgumentParser(description="Install all jointris projects."
	...
	print("== install libstmm-jointris =============" + sInfo + "==")
	os.chdir("libstmm-jointris/scripts")
	subprocess.check_call("./install_libstmm-jointris.py {} {} {} {} {} {} {} {} {} {} {}".format(\
	...
	print("== install libstmm-jointris-xml ==========" + sInfo + "==")
	os.chdir("libstmm-jointris-xml/scripts")
	subprocess.check_call("./install_libstmm-jointris-xml.py {} {} {} {} {} {} {} {} {} {}".format(\
			sBuildStaticLib, sBuildTests, sBuildDocs, sDocsWarningsToLog, sBuildType, sInstallDir\
			, sNoConfigure, sNoMake, sNoInstall, sSudo).split())
	os.chdir("../..")

	print("== install jointris ==========" + sInfo + "==")
	os.chdir("jointris/scripts")
	subprocess.check_call("./install_jointris.py {} {} {} {} {} {} {} {} {}".format(sBuildStaticLib, sBuildType\
