...
# File:   uninstall_jointris-all.py

# Removes all files installed by the install_jointris-all.sh script.
...
def main():
	import argparse
	oParser = argparse.ArgumentParser("Removes all files created by install_jointris-all.py")
	...
	subprocess.check_call("./libstmm-jointris/scripts/uninstall_libstmm-jointris.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-jointris-xml/scripts/uninstall_libstmm-jointris-xml.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./jointris/scripts/uninstall_jointris.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())
