...
# File:   pk_install_jointris-all.py
...
# In addition to the install_jointris-all.py parameters it sets the STMM_DEBIAN_PACKAGING
...
def main():
	...
	oParser = argparse.ArgumentParser(description="Install all jointris projects.\n"
						"  Same as install_jointris-all.py but sets STMM_DEBIAN_PACKAGING environment variable\n"
						"  to ON."
	...
	subprocess.check_call("./install_jointris-all.py {} {} {} {} {} {} {} {} {} {} {} {}".format(\
