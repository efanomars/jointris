...
# File:   dd_install_jointris-all.py
...
# In addition to the pk_install_jointris-all.py parameters it sets the DESTDIR 
...
def main():
	...
	oParser = argparse.ArgumentParser(description="Install all jointris projects.\n"
						"  Same as pk_install_jointris-all.py but sets DESTDIR environment variable.\n"
	...
	subprocess.check_call("./pk_install_jointris-all.py {} {} {} {} {} {} {} {} {} {} {} {}".format(\
