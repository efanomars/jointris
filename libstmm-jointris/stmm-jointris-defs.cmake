# File: libstmm-jointris/stmm-jointris-defs.cmake
...
set(STMM_JOINTRIS_MINOR_VERSION 23) # !-U-!
...
set(STMM_JOINTRIS_REQ_STMM_GAMES_MINOR_VERSION 23) # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-jointris)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-jointris SHARED IMPORTED)
#     else()
#         add_library(stmm-jointris STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-jointris PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-jointris PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMJOINTRIS_INCLUDE_DIRS}")
#     set_target_properties(stmm-jointris PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMJOINTRIS_EXTRA_LIBRARIES}")
# endif()
