# File: libstmm-jointris-xml/stmm-jointris-xml-defs.cmake
...
set(STMM_JOINTRIS_XML_MINOR_VERSION 23) # !-U-!
...
set(STMM_JOINTRIS_XML_REQ_STMM_JOINTRIS_MINOR_VERSION 23) # !-U-!
...
set(STMM_JOINTRIS_XML_REQ_STMM_GAMES_XML_GAME_MINOR_VERSION 23) # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-jointris-xml)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-jointris-xml SHARED IMPORTED)
#     else()
#         add_library(stmm-jointris-xml STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-jointris-xml PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-jointris-xml PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMJOINTRISXML_INCLUDE_DIRS}")
#     set(STMMI_TEMP_PROPS "")
#     get_target_property(STMMI_TEMP_STMMJOINTRIS_PROP stmm-jointris INTERFACE_LINK_LIBRARIES)
#     list(APPEND STMMI_TEMP_PROPS "${STMMI_TEMP_STMMJOINTRIS_PROP}")
#     list(APPEND STMMI_TEMP_PROPS "stmm-jointris")
#     list(APPEND STMMI_TEMP_PROPS "${STMMGAMESXMLGAME_LIBRARIES}")
#     set_target_properties(stmm-jointris-xml PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMI_TEMP_PROPS}")
# endif()
